define({ "api": [
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8000/api/accessToken"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8000/api/request-for-unverified-rating"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8000/api/request-for-unverified-rating-review"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8000/api/publish-unverified-rating/{id}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8000/api/all-unverified-rating"
      }
    ]
  }
] });
