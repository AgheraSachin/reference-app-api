define({ "api": [
  ...
  {
    "type": "get",
    "url": "/all-verified-rating?page={page_number}&per_page={count}",
    ...
    "sampleRequest": [
      {
        "url": "https://reference.app/api/public/api/all-verified-rating?page={page_number}&per_page={count}"
      }
    ]
  },
  {
  ...
  {
    "type": "get",
    "url": "/all-unverified-rating?page={page_number}&per_page={count}",
